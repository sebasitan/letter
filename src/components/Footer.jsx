          ...
          <div className="grid grid-cols-2 md:grid-cols-12 gap-8">
            ...
            <div className="col-span-2 md:col-span-4">
              ...
              <div className="flex gap-3 mt-5">
                {[
                  ...
                  // WhatsApp is always live; Instagram and Facebook only appear
                  // once you set them in src/lib/business.js. A dead social icon
                  // costs more trust than a missing one.
                  const href = [SOCIAL.instagram, SOCIAL.facebook, waLink()][i]
                  const label = ['Instagram', 'Facebook', 'WhatsApp'][i]
                  if (!href) return null
                  return (
                    <a key={i} href={href} target="_blank" rel="noopener noreferrer" aria-label={label}
                      className="w-11 h-11 md:w-9 md:h-9 rounded-full flex items-center justify-center transition-colors"
                      style={{ backgroundColor: 'rgba(255,255,255,0.06)', color: '#D9A839' }}>
            ...
            <div className="md:col-span-2">
              ...
              <ul className="space-y-2.5 text-sm" style={{ color: 'rgba(251,246,240,0.6)' }}>
                ...
                <li><Link to="/refunds" className="hover:text-white transition-colors">Refunds &amp; Cancellation</Link></li>
            ...
            <div className="col-span-2 md:col-span-2 md:text-right">
              ...
              <p className="text-xs mt-2" style={{ color: 'rgba(251,246,240,0.4)' }}>&copy; {new Date().getFullYear()} Ever Yours.<br />All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
