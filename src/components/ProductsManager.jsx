...
const SCHEMAS = {
  ...
  gifts: {
    ...
    fields: [
      ...
      { k: 'personalisation_type', label: 'Ask the customer for', type: 'select', options: ['none', 'name', 'date', 'whatsapp'] },
      { k: 'personalisation_label', label: 'Question or note shown to the customer', type: 'text' },
